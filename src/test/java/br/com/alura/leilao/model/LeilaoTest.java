...
public class LeilaoTest {
	...
	class UnicoLanceTests {
	    ...
	    // Aqui é o primeiro DisplayName. Temos um item de leilão e um valor a ser inserido, que deve ser um valor válido.
	    ...
	    class AssertLanceNormal {
	        ...
	        public void deveReceberUmLance() {
	            ...
	            // Como o lance é válido, o valor esperado é que seja aceito
